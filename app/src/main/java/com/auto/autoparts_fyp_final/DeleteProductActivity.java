...
public class DeleteProductActivity extends AppCompatActivity {
    ...
    RecyclerView.LayoutManager layoutManagerDelete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_menu_delete);
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(DeleteProductActivity.this, DeleteProductDetailsActivity.class);
    ...
    {
        Intent intent = new Intent(DeleteProductActivity.this, VendorMainActivity.class);
        startActivity(intent);
