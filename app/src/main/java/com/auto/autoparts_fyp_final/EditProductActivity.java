...
public class EditProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_menu_edit);
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(EditProductActivity.this, EditProductDetailsActivity.class);
    ...
    {
        Intent intent = new Intent(EditProductActivity.this, VendorMainActivity.class);
        startActivity(intent);
